...
public class ModuleViewController {
	...
	String urlParameters = String.format("{\"req_data_length\":1,\"req_data\":[{\"master_sid\":\"20\", \"main_code\":\"003\", \"sub_code\":\"%s\",\"name\":\"%s\",\"description\":\"%s\", \"value\":\"12\", \"seq_order\":\"4561\",\"module\":\"kaushik\",\"is_active\":\"%d\", \"updated_by\":\"12\", \"comment\":\"kaushik\",\"ref_01\":\"ref_02\",\"used_code\":\"1\"}] }",subcode,name,description, flag);
