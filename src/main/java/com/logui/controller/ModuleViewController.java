...
public List<LogTypeModel> listModuleInfo(String username){
	...
	System.out.println(mastersid+"--------------------------------------------------------------------------------------------------------------");
		...
		try
		{
			URL url = new URL("http://54.153.82.170:4000/atest/api/logging_code_dict/id/"+mastersid+"/003");
			...
			for(int i=0;i<jsonarr_1.size();i++)
			{
				...
				JSONObject jObj = (JSONObject)jsonarr_1.get(i);
					...
					listofmodule.add(loggrouplistobj);
	...
	String urlParameters = String.format("{\"req_data_length\":1,\"req_data\":[{\"master_sid\":\"%d\", \"main_code\":\"003\", \"sub_code\":\"%s\",\"name\":\"%s\",\"description\":\"%s\", \"value\":\"12\", \"seq_order\":\"4561\",\"module\":\"kaushik\",\"is_active\":\"%d\", \"updated_by\":\"%s\", \"comment\":\"kaushik\",\"ref_01\":\"ref_02\",\"used_code\":\"1\"}] }",mastersid, subcode,name,description, flag, master_username);
	...
	public List<LogTypeModel> listModuleInfo(int sid){
...
public String edit(String Username, String active, int sid) throws Exception {
	...
	ArrayList<LogTypeModel> loglist = (ArrayList<LogTypeModel>) listModuleInfo(sid);
...
else
{
    ...
    public String  editLogtype(Model model,@RequestParam String username, @RequestParam String active, @RequestParam int id) {
		...
		System.out.println("++++++++++++_________________________ID_____________________++++++++++++"+id);
		try {
	...
	@RequestMapping(value = "/moduleView", method = RequestMethod.POST )
