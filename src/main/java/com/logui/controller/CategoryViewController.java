...
public List<LogTypeModel> listCategoryInfo(int sid){
	...
	String urlParameters = String.format("{\"req_data_length\":1,\"req_data\":[{\"master_sid\":\"%d\", \"main_code\":\"002\", \"sub_code\":\"%s\",\"name\":\"%s\",\"description\":\"%s\", \"value\":\"12\", \"seq_order\":\"4561\",\"module\":\"kaushik\",\"is_active\":\"%d\", \"updated_by\":\"%s\", \"comment\":\"kaushik\",\"ref_01\":\"ref_02\",\"used_code\":\"1\"}] }",mastersid,subcode,name,description, flag, master_username);
...
public String edit(String Username, String active, int sid) throws Exception {
		...
		LogTypeViewController ltvc = new LogTypeViewController();
		
	
	ArrayList<LogTypeModel> loglist = (ArrayList<LogTypeModel>) listCategoryInfo(sid);
